     ...
     {printerTab==="regular" ? <div className="printer-settings-layout">
       ...
       <div className="printer-live-preview"><div className="preview-toolbar"><span>Live Preview</span><span>{ps.paperSize} · {ps.orientation}</span></div><div className={`printer-paper ${ps.orientation==="Landscape"?"landscape":""} doc-preview-layout-${style.layout||"standard"}`} style={{"--accent":style.accent||colors.accent}}>
         <div className="paper-head">
           ...
           <div><b>{business.name||"Nexsa Technologies"}</b><small>{business.address||"Business address"}<br/>{ps.phone?(business.phone||"8208581567"):""} {ps.email?(business.email||"nexsatechnologies@gmail.com"):""}<br/>{ps.gstin?(business.gstin||"GSTIN: SAMPLE GSTIN"):""}</small></div>
         ...
         <div className="paper-footer"><div><b>Terms & Conditions</b><span>Payment due within 10 days. Goods/services subject to applicable GST.</span></div><div><b>Bank / Payment</b><span>UPI: Your UPI ID<br/>Thank you for your business.</span></div><div className="signature"><span>Authorized Signature</span></div></div>
       </div></div>
